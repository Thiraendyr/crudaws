...
public class GetMethods {
	...
	public static Contact getRNContactByEmail(String email) throws IOException, JSONException {
	...
	public static Contact getOSContactByEmail(String email) throws IOException, JSONException {
	...
	public static Contact getElContactByEmail(String email) throws IOException, JSONException {
	...
	public static LeadOSC getOSLeadByPrimaryContactEmailAddress(String email) throws IOException, JSONException {
